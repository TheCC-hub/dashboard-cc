...
export default function LoginForm() {
    ...
    return (
        <div className="max-w-md mx-auto bg-[var(--color-background-2)] rounded-2xl shadow-xl p-8 relative">
            ...
            <div className="mb-3">
                ...
                <div className="relative">
                    ...
                    <input
                        name="email"
                        type="email"
                        placeholder="andrew_gregory@gmail.com"
                        value={form.email}
            ...
            <button
                className="w-full bg-red-400 hover:bg-red-500 text-white py-2 rounded-md font-medium cursor-pointer transition duration-300 ease-in-out"
